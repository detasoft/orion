...
an ordered finding queue to `orion-review-orchestrator`. Require `minimal-implementation` when ranking and
...
3. Require `minimal-implementation` for consumer, invariant, and contract checks before ranking or repair.
