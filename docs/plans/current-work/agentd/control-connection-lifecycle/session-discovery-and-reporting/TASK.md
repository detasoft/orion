...
Status: todo
Depends on: ../handshake-and-authentication/TASK.md and completed session discovery.
Server contract: [Session reconciliation](../../../agent-session-server/control-and-registries/session-reconciliation-and-ownership/TASK.md)
