...
- Owner: codex, session 01a0d010-05d8-7b91-a154-45200daf87f0, branch `codex/hierarchical-authorization-01a0d010`,
  worktree `.worktrees/hierarchical-authorization-01a0d010`, paused 2026-09-24 10:02 Europe/Amsterdam;
  next: resolve stale membership/disabled-user requirements against the shared user model introduced in 09c53305.
