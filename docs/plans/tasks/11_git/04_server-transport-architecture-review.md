...
Status: todo
Depends on:
[the Git wire re-audit](01_wire-architecture-simplification/06_post-simplification-review.md),
[the Git client removal re-audit](02_client-architecture-simplification/06_post-simplification-removal-review.md),
[remote Git proxy bootstrap](../06_remote-git-proxy-bootstrap/TASK.md)
Blocks: [the virtual-thread Git transport migration](05_virtual-thread-server-transport.md)
