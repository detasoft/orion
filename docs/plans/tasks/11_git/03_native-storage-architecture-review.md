...
Status: todo
Depends on:
[canonical Git object IDs](01_wire-architecture-simplification/01_canonical-git-object-id.md),
[the parser/storage boundary](01_wire-architecture-simplification/03_parser-storage-boundary.md),
[one repository command context](01_wire-architecture-simplification/04_repository-command-context.md)
Blocks: [externalized repository storage](06_externalized-repository-storage.md)
