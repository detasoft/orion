...
The integrated canonical reachability walk defines the
...
[The commit information projection](08_commit-information-projection.md) defines a rebuildable
...
The integrated native upload-pack path needs fast
...
The integrated native receive-pack path needs fast-forward
...
[Repository maintenance](09_repository-maintenance.md) needs liveness scans
...
The integrated thin-pack generation path needs proven
