...
| C1b | [Resolved ACL repository identity](current-work/11_resolved-acl-repository-identity.md) | Independent of Local characterization; remove the second identity decode before broader normalization. |
