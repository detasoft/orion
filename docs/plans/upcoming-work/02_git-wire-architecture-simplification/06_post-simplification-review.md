...
[native Git storage architecture review](../05_git-native-storage-architecture-review.md)
...
- Re-run `minimal-implementation` in read-only review mode over `git-parser`, `git-client`,
